...
export const register = newUser => {
  ...
  const posting = (newUser.title.length  >1 || newUser.address.length >1 ||
                    newUser.content.length  >1);
  ...
  return axios
    .post('http://127.0.0.1:5000/user/new', {
      ...
      date_posted:newUser.date_posted,
...
class Register extends Component {
  ...
  onSubmit(e) {
    ...
    if(this.state.end_date>this.state.start_date)
        this.state.errors.dates_invalid  = 'invalid dates';
         ...
         if(this.state.username.length < 1 ||
             ...
             register(newUser).then(res => {
                 ...
                 if (res == 'missing_address') {
                     ...
                     this.setState({invalid: 1});
                     console.log("if (missing_address");
                 }
