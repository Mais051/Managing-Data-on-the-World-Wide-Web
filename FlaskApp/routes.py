...
def register():
    ...
    if form.validate_on_submit():
        ...
        user = User(username=form.username.data, first_name=form.first_name.data, last_name=form.last_name.data, gender=form.gender.data, birth_date=form.birth_date.data, email=form.email.data, password=hashed_password)
        db.session.add(user)
        db.session.commit()
...
def delete_post_user(travel_id):
    ...
    return redirect(url_for('user_account', user_id=post.traveler.id))
